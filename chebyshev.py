...
def integrate(x_0, y_0, z_0, n, t_step):
    ...
    k_4 = t_step * f(x_0 + t_step, y_0 + k_3, z_0 + l_3)
    l_4 = t_step * g(x_0 + t_step, y_0 + k_3, z_0 + l_3, n)
    x_1 = x_0 + t_step
    y_1 = y_0 + 1/5 * (k_0+2*k_1+2*k_2+k_3+k_4)
    z_1 = z_0 + 1/5 * (l_0+2*l_1+2*l_2+l_3+l_4)
    return (x_1, y_1, z_1)
